...
class Config:
    ...
    DATA_SYNC_RATE_LIMIT = int(os.environ.get('DATA_SYNC_RATE_LIMIT', '10'))  # 每秒请求数
    DATA_SYNC_MAX_RETRIES = int(os.environ.get('DATA_SYNC_MAX_RETRIES', '3'))
    DATA_SYNC_TIMEOUT = int(os.environ.get('DATA_SYNC_TIMEOUT', '30'))  # 秒
    ...
    CACHE_CONFIG = {
        ...
        'match_detail': 60,       # 1分钟(直播中) / 1800(已结束)
